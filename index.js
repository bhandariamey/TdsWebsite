...
const client_details = [
    ...
    },
    {
        ...
        description: "Step into the epitome of warmth and luxury in our recently completed project situated in Parvati, Pune. Emanating welcoming charm, the space is a symphony of comfort and sophistication. Each room boasts a cozy ambiance, inviting residents and guests alike to experience a luxurious haven. Meticulously curated elements contribute to a cohesive and opulent look throughout. From sumptuous furnishings to thoughtfully placed accents, every detail exudes a sense of refined living. Our design transcends traditional boundaries, creating a home that not only meets but exceeds expectations, redefining the essence of modern elegance and comfort.",
        carousel_images:[
            './photos/sites/Aaplaghar/11-min.jpg',
            './photos/sites/Aaplaghar/2-min.jpg',
             './photos/sites/Aaplaghar/3-min.jpg', 
             './photos/sites/Aaplaghar/4-min.jpg',
             './photos/sites/Aaplaghar/5-min.jpg',
             './photos/sites/Aaplaghar/6-min.jpg',
             './photos/sites/Aaplaghar/7-min.jpg',
             './photos/sites/Aaplaghar/8-min.jpg',
             './photos/sites/Aaplaghar/9-min.png',
             './photos/sites/Aaplaghar/10-min.png',
             './photos/sites/Aaplaghar/12-min.jpg',
             './photos/sites/Aaplaghar/13-min.jpg',
         ]
    },

    {
        ...
        description: "Step into the epitome of warmth and luxury in our recently completed project situated in Parvati, Pune. Emanating welcoming charm, the space is a symphony of comfort and sophistication. Each room boasts a cozy ambiance, inviting residents and guests alike to experience a luxurious haven. Meticulously curated elements contribute to a cohesive and opulent look throughout. From sumptuous furnishings to thoughtfully placed accents, every detail exudes a sense of refined living. Our design transcends traditional boundaries, creating a home that not only meets but exceeds expectations, redefining the essence of modern elegance and comfort.",
        carousel_images:[
            " ./photos/sites/Lighthouse/2-min.jpg", 
             './photos/sites/Lighthouse/1-min.jpg',
             './photos/sites/Lighthouse/3-min.jpg', 
             './photos/sites/Lighthouse/5-min.jpg',
             './photos/sites/Lighthouse/7-min.jpg',
             './photos/sites/Lighthouse/9-min.jpg',
             './photos/sites/Lighthouse/10-min.png',
             './photos/sites/Lighthouse/11-min.jpg',
             './photos/sites/Lighthouse/12-min.jpg',
             './photos/sites/Lighthouse/13-min.jpg',
